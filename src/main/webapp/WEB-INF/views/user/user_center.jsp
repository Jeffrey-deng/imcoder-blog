                                        ...
                                        <div class="tab-content col-xs-8">
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="setting_album">
                                                <form id="setting_album_form" method="post" class="form-horizontal">
                                                    <div class="form-group">
                                                        <a href="<%=basePath%>p/dashboard?model=photo" target="_blank" style="color:#444;">
                                                    ...
                                                    <div class="hr-line-dashed"></div>
                                                    <div class="form-group">
                                                        <a href="<%=basePath%>u/abums" target="_blank" style="color:#444">
                                                    ...
                                                    <div class="hr-line-dashed"></div>
                                                    <div class="form-group">
                                                        <a href="<%=basePath%>u/videos" target="_blank" style="color:#444">
                ...
                <div class="ibox chat-view">
                    <div class="ibox-content container-fluid">
                        ...
                        <div class="row" style="padding-top:5px;">
                            <div class="form-group">
                                <div class="col-sm-9 col-xs-12">
                                    <button class="letter-control letter-btn-insert-image-modal-open btn btn-sm" id="openInsertImageModalTrigger" title="发送图片"><i class="glyphicon glyphicon-picture"></i></button>
                                    <textarea class="form-control letter-input-content" id="sendLetter_area" name="sendLetter_area" placeholder="输入消息内容，按ctrl+enter发送"></textarea>
                                </div>
                                <div class="col-sm-3 col-xs-5 btngroup">
                                    ...
                                    <button type="button" id="sendLetter_submit" onclick="" class="btn btn-primary">发送</button>
                                </div>
                            </div>
                        </div>
                    </div>
