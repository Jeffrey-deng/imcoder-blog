        ...
        <div class="">
            <div class="container">
                <div class="" style="text-align:center">
                    <h1 class="slogan-name" data-user-id="<s:eval expression="loginUser.uid"/>">${loginUser.nickname}</h1>
                    <h3 class="slogan-desc">${loginUser.description}</h3>
                </div>
            </div>
        </div>
    </div><!-- END COVER -->
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse hiddenscorll" id="navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="<%=basePath%>u/history">用户历史</a></li>
            </ul>
                    ...
                    <div class="panel-footer">
                        <div class="btn-group btn-group-justified" role="group" aria-label="...">
                            <div class="btn-group user_history_articles" role="group">
                                <a class="btn btn-info" href="<%=basePath%>a/list?accessed=true" target="_blank">文章</a>
                            </div>
                            <div class="btn-group user_history_photos" role="group">
                                <a class="btn btn-warning" href="<%=basePath%>u/<s:eval expression="loginUser.uid"/>/history/photos" target="_blank">照片</a>
                            </div>
                            <div class="btn-group user_history_videos" role="group">
                                <a class="btn btn-danger" href="<%=basePath%>u/<s:eval expression="loginUser.uid"/>/history/videos" target="_blank">视频</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-footer">
                        <div class="btn-group btn-group-justified" role="group" aria-label="...">
                            <div class="btn-group user_likes_articles" role="group">
                                <a class="btn btn-info" href="<%=basePath%>u/<s:eval expression="loginUser.uid"/>/center/collections" target="_blank">文章</a>
                            </div>
                            <div class="btn-group user_likes_photos" role="group">
                                <a class="btn btn-warning" href="<%=basePath%>u/<s:eval expression="loginUser.uid"/>/likes/photos" target="_blank">照片</a>
                            </div>
                            <div class="btn-group user_likes_videos" role="group">
                                <a class="btn btn-danger" href="<%=basePath%>u/<s:eval expression="loginUser.uid"/>/likes/videos" target="_blank">视频</a>
                            </div>
                        </div>
                    </div>
                </div>
