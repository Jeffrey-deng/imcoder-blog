        ...
        <div class="">
            <div class="container">
                <div class="" style="text-align:center">
                    <h2 class="slogan_name" data-host-user="<s:eval expression="hostUser.uid"/>">${hostUser.nickname}</h2>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding-bottom: 0px;">
                ...
                <div class="form-group tag-wrapper-common-value-group">
                ...
                <div class="form-group tag-wrapper-topic-group">
                ...
                <div class="form-group sync-topic-to-photos-group">
                ...
                <div class="form-group sync-topic-to-photos-mode-group">
