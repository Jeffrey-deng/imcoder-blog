...
<%
	...
	if (rowCount > 0 && (pageUtil.getCurrentPage() > 1 || !description.equals(""))) {
		...
		description = "此site为大学学完Java后，为练习而开发的，后面发现可以用来总结下平时所学的知识，便一直在维护。欢迎一起学习交流！ contact me ~ chao.devin@gmail.com";
	}

	if (title == null) {
		title = "CODER 博客";
	} else {
		title = title + " - CODER 博客";
	}
...
<head>
	...
	<meta name="keywords" content="CODER 博客,程序员,码农,JAVA,大数据">
	<!-- 使用url函数转换相关路径 -->
			...
			<article class="row">
						...
						<article class="post" itemscope="" itemtype="http://schema.org/BlogPosting">
							...
							<footer class="post-footer">
								<p>
									...
									<a class="post-comments" itemprop="discussionUrl" href="article.do?method=detail&aid=${article.aid}#comments" target="_blank">
										<c:choose>
				...
				<aside class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <section class="post" id="photos_show">
                        <p class="ui red ribbon label"><a title="点击打开相册广场" target="_blank" href="photo.do?method=dashboard&mode=album" style="color:white;text-decoration: none;" >Photos</a></p>
                        <p></p>
                        <div class="photos">
                        </div>
                    </section>
