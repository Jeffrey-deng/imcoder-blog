			...
			<article id="main" class="col-md-12 col-sm-12 col-xs-12" role="main">
				...
				<ol class="page-navigator">
					<c:if test="${ not empty page }">
						...
						<c:if test="${page.currentPage-3 >= 2}">
							<li><a href="javascript:page_jump(1);">1</a></li>
							<c:if test="${page.currentPage-3 >= 3}" >
								<li><span>...</span></li>
							</c:if>
						</c:if>
						<c:forEach begin="${(page.currentPage-3 >= 2)?page.currentPage-3:1 }" end="${page.currentPage-1}"  var="pagenum">
						...
						<c:forEach  begin="${page.currentPage+1}" end="${(page.currentPage+3 <= page.pageCount-1)?page.currentPage+3:page.pageCount  }" var="pagenum">
							<li><a href="javascript:page_jump(${pagenum});">${pagenum}</a></li>
						</c:forEach>
						<c:if test="${page.currentPage+3 <= page.pageCount-1}">
