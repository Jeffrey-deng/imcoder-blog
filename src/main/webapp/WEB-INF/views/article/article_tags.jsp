...
<head>
    ...
    <style>
        ...
        #navbar-collapse > ul:nth-child(1) > li.active > a, #header .dropdown-toggle {
            background-color: rgba(255, 255, 255, 0);
        }

        #header, #header input, #header .btn-search, #header .dropdown-menu {
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse hiddenscorll" id="navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="<%=basePath%>a/tags">标签</a></li>
            </ul>
                            ...
                            <ul class="notes">
                                <c:if test="${ not empty tagList }">
                                    <c:forEach items="${tagList}" var="tag">
                                        <li>
                                            <a href="<%=basePath%>a/list?tags=${tag.key}" target="_blank">
                                                <div class="note-div">
                                                    <h4>${tag.key}</h4>
                                                    <p>${tag.value} 文章</p>
                                                </div>
