...
public class Config {
    ...
    public static void setDefault() {
        ...
        //CDN地址，以"/"结尾
        set(ConfigConstants.SITE_CDN_ADDR, "http://localhost:8080/blog/");

        //cloud地址，以"/"结尾
        set(ConfigConstants.SITE_CLOUD_ADDR, "http://localhost:8080/cloud/");

        //上传文件存储相对路径 相对于其基础路径
        set(ConfigConstants.ARTICLE_UPLOAD_RELATIVEPATH, "upload/");

        //上传文件存储基础路径 相对于context父文件夹
        set(ConfigConstants.ARTICLE_UPLOAD_BASEPATH, "static/");

        //云盘文件存储相对路径 相对于其基础路径
        set(ConfigConstants.CLOUD_FILE_RELATIVEPATH, "user/");

        //云盘文件存储基础路径 相对于context父文件夹
        set(ConfigConstants.CLOUD_FILE_BASEPATH, "cloud/");
